...
public class InformacoesPedidoDto {// vai trazer as informações do pedido
	...
	private List<InformacaoItemPedidoDto> items;// sera criada uma lista com a informação do itens do pedido e será
												// populada para trazer informações
	...
	public InformacoesPedidoDto(Integer codigo, String cpf, String nomeCliente, BigDecimal totalPedido,
			String dataPedido, String status, List<InformacaoItemPedidoDto> items) {
		this.codigo = codigo;
		this.cpf = cpf;
